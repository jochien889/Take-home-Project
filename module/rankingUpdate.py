        ...
        try:
            ...
            if 'html' in res:
                ...
                if res['stat'] == "OK" and res['data'] and res['fields'] :
                    ...
                    print("[ERROR_requestsUtil]", {'ticker':ticker,"url": url, "response: ": res} )
                    return False
        except Exception as e:
            traceback.print_exc()

    def _returnCal(self, ticker, data):
        """
            data =  [
        ...
        try:
            ...
            if dataExtract :
                if "--" in dataExtract[0] or "X0.00" in dataExtract[0]:
        ...
        try:
            for industry, vals in self.industrySort.items():
                ...
                for val in vals:
                    ...
                    if res: 
                        data = res['data']
                        result = self._returnCal(ticker, data)
                        if result:
                            print(result)
